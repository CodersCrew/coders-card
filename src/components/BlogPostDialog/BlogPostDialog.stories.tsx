...
const basePropsData = {
  ...
  imgurl: 'https://picsum.photos/320/180',
  contentMain:
...
export const Mobile = (): JSX.Element => {
  return <PostDialog type="mobile" {...basePropsData} />;
};

export const Desktop = (): JSX.Element => {
  return <PostDialog type="desktop" {...basePropsData} />;
};

export const Tablet = (): JSX.Element => {
  return <PostDialog type="tablet" {...basePropsData} />;
};
